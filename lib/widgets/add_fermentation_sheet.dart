            ...
            : Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      l10n.addSheetPastSelected('${_customStartDate!.day}/${_customStartDate!.month} ${_customStartDate!.hour}:${_customStartDate!.minute.toString().padLeft(2, '0')}'),
                      textAlign: TextAlign.center,
                      style: TextStyle(
  ...
  Widget _buildKefirSelection() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        ...[24, 36, 48].map((hours) => Padding(
              padding: const EdgeInsets.only(bottom: 12.0),
              child: FilledButton.tonal(
                onPressed: () => _start(hours * 3600),
                child: Text(l10n.addSheetHours(hours)),
              ),
            )),
            ...
            if (idealSecs != null)
              Padding(
                ...
                child: FilledButton(
                  ...
                  child: Text(
                      l10n.addSheetIdealTime(num.parse((idealSecs / 86400).toStringAsFixed(1)))),
                ),
              ),
            ...[7, 10, 14].map((days) => Padding(
                  padding: const EdgeInsets.only(bottom: 12.0),
                  child: FilledButton.tonal(
                    onPressed: () => _start(days * 86400),
                    child: Text(l10n.addSheetDays(days)),
                  ),
                )),
            _buildPastDateSelector(),
          ],
